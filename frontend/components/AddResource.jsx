    ...
    return (
        <>
            <div className="flex flex-col h-screen">
                ...
                <div className="[flex-grow:20] bg-[#CCD2F2] flex flex-col">
                    ...
                    <form className="font-['Anton'] flex flex-col [flex-grow:24] w-[25vw] mx-auto items-center">
                        <p className="text-3xl">Add Resources</p>
                        <input type="text" placeholder="Resource Name" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <input type="url" placeholder="Github Link" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <input type="url" placeholder="Notion Link" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <input type="url" placeholder="Any Other link if needed" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <input type="text" placeholder="Upload Banner photo" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <button className="mt-4 w-full bg-[#98A3E0] border-2 border-black p-2 cursor-pointer">Submit</button>
                    </form>
                </div>
            </div>
        </>
