            ...
            <div className="flex flex-col h-screen">
                ...
                <div className="[flex-grow:20] bg-[#ffcca6] flex flex-col">
                    ...
                    <form className="font-['Anton'] flex flex-col [flex-grow:24] w-[25vw] mx-auto items-center">
                        <p className="text-3xl">Add Project Member details</p>
                        <input type="text" placeholder="Member Name" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <input type="text" placeholder="Registration Number" className="mt-4 w-full bg-white border-2 border-black p-2"/>
                        <button className="mt-4 w-full bg-[#ff6863] border-2 border-black p-2 cursor-pointer">Next / Submit</button>
                    </form>
                </div>
            </div>
        </>
...
export default AddProjectMember1