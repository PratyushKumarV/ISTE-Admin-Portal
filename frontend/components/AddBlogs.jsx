        ...
        <>
            <div className="flex flex-col h-screen">
                ...
                <div className="[flex-grow:20] bg-[#fcb8b5] flex flex-col">
                    <button className="font-['Anton'] text-4xl [flex-grow:1] self-start mt-[6vh] ml-[6vw]">Back</button>
                    <form className="font-['Anton'] flex flex-col [flex-grow:24] w-[25vw] mx-auto items-center">
                        ...
                        <button className="mt-4 w-full bg-[#ff6863] border-2 border-black p-2">Submit</button>
                    </form>
                </div>
            </div>
        </>
